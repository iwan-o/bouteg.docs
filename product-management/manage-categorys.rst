...
Chaque produit doit appartenir à au moins une catégorie. Exemple : les carottes sont rangés dans la catégorie "Légumes". 
Cela permet de faciliter la navigation pour vous mais aussi pour vos visiteurs sur la boutique via la création du menu 
et de pages listant les produits de la catégorie.
...
----------------------------
Vous pouvez changer l’ordre d’affichage des catégories dans le menu de votre boutique.
